        ...
        <View style = {{flex:1}}>
          <LinearGradient
            ...
            <View style = {styles.secondContainer}>
              <TouchableOpacity style = {[styles.littleContainer, styles.margin, styles.marginTop, styles.aline]}>
                <Icon name="questioncircleo" size={35} color='#fff'/>
              </TouchableOpacity>
              <TouchableOpacity style = {[styles.littleContainer, styles.margin, styles.marginTop, styles.aline]}>
                <Icon name="solution1" size={35} color='#fff'/>
              </TouchableOpacity>
            </View>
            <TouchableOpacity style = {[styles.littleContainer, styles.marginTop, styles.aline]}>
