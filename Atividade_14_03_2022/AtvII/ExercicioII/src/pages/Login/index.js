      ...
      <SafeAreaView style = {{flex:1}}>
        ...
        <View style = {[styles.container]}>
          <View style = {[styles.beforeContainer]} >
            ...
            <View style = {[styles.insideBeforeContainer]}>
              <Icon style = {[styles.iconTwo]} name ='search' size={25} color='#fff'/>
            </View>
          </View>
          ...
          <View style = {[styles.containerTwo]}>
           ...
           <View style = {[styles.boxTwo]}>
             <View style = {[styles.littleBox, styles.aline]}>
               <Icon name ='messenger' size={30} color='#000'/>
             </View>
             <View style = {[styles.littleBox, styles.aline]}>
               <Icon name ='commenting' size={30} color='#000'/>
             </View>
           </View>
